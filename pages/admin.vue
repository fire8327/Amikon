<template>
    <div class="flex flex-col gap-6">
        ...
        <button :disabled="isAddDisabled" :class="{ 'opacity-50 cursor-not-allowed': isAddDisabled }" type="submit" class="px-4 py-2 border border-violet-500 bg-violet-500 text-white rounded-full w-[160px] text-center transition-all duration-500 hover:text-violet-500 hover:bg-transparent">Регистрация</button>
    </FormKit>
    </div>
    <div class="flex flex-col gap-6">
